...
class Window5 extends React.Component {
    render() {
        return(
            <div className="row window">
                ...
                <div className="col-md-8 register">
                    ...
                    <p style={{marginTop: 80, marginBottom: 80}}><b>How many gas stations you want to manage using Shift Log ?</b></p>
                        ...
                        <div className="col-md-4">
                            <div className="form-group">
                                <select className="form-control" id="sel1">
                                    ...
                                    <option>4</option>
                                    <option>5</option>
                                    <option className="active">6</option>
