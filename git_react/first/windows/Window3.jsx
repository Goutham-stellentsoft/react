        ...
        return(
            <div className="row window">
                ...
                <div className="col-md-8 register">
                    ...
                    <p className="secpage"><b>Thank you for signing up to Shift Log.We will send you email confirming your registration.Please click on the link to confirm your registration to setup your account with us</b>
                    </p>
